    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('tenant_admin', 'Tenant Admin'), ('project_manager', 'Project Manager'), ('hr', 'HR'), ('developer', 'Developer')], max_length=30)),
